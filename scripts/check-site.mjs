...
const checks = [
  ...
  ['verified experiments are curated', /Experiment 001/.test(html) && /Experiment 002/.test(html) && /Experiment 005/.test(html) && /005-testimony-policy-lab/.test(html) && /Experiment 006/.test(html) && /006-checkpoint-tail-comparator/.test(html) && /Experiment 009/.test(html) && /009-verdict-drift-lens/.test(html) && /Experiment 011/.test(html) && /011-threshold-voice-atlas/.test(html)],
